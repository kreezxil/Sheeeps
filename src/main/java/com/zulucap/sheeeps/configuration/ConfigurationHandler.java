...
public class ConfigurationHandler {
    ...
    public static void init(File configFile){
        ...
        try{
            ...
            diamondSheep.setMaxSpawnHeight(configuration.get("Config Diamond Sheep", "Max Spawn Height", 25, "Sets the maximum height this sheep will spawn").getInt());
            ...
            emeraldSheep.setMaxSpawnHeight(configuration.get("Config Emerald Sheep", "Max Spawn Height", 25, "Sets the maximum height this sheep will spawn").getInt());
